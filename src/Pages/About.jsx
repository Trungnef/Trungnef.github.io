...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      CV-backed profile overview and career highlights
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
    ...
    <div className="relative z-10 bg-gray-900/50 backdrop-blur-lg rounded-2xl p-6 border border-white/10 overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl h-full flex flex-col justify-between">
      ...
      <div>
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <ArrowUpRight className="w-4 h-4 text-white/50 group-hover:text-white transition-colors shrink-0" />
        </div>
      </div>
    </div>
  </div>
...
const DetailCard = memo(({ icon: Icon, title, lines, animation }) => (
  <div
    data-aos={animation}
    data-aos-duration="1200"
    className="rounded-2xl border border-white/10 bg-gray-900/40 p-6 backdrop-blur-lg"
  >
...
const AboutPage = () => {
  ...
  const statsData = useMemo(
    () =>
      PROFILE_STATS.map((item, index) => ({
        ...item,
        icon: index === 0 ? GraduationCap : index === 1 ? Award : Briefcase,
        color:
          index === 1
  ...
  const quickInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Contact",
      lines: [PROFILE.email, PROFILE.phoneDisplay],
      animation: "fade-up",
    },
    {
      icon: GraduationCap,
      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href={PROFILE.cvPath} className="w-full lg:w-auto" target="_blank" rel="noopener noreferrer">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
              ...
              <a href="#Portofolio" className="w-full lg:w-auto">
                ...
                >
                  <Code className="w-4 h-4 sm:w-5 sm:h-5" /> View Highlights
                </button>
              </a>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-10">
          ...
          <DetailCard
            ...
            animation="fade-left"
            lines={HONORS_AND_AWARDS.slice(0, 3).map(
