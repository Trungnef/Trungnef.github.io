    ...
    <div className="relative group">
      ...
      <div className="relative px-3 sm:px-4 py-2 rounded-full bg-black/40 backdrop-blur-xl border border-white/10">
        <span className="bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-transparent bg-clip-text sm:text-sm text-[0.7rem] font-medium flex items-center">
          ...
          Open to AI, NLP, and LLM opportunities
        </span>
      </div>
    </div>
  </div>
...
const TECH_STACK = PROFILE.heroTechStack;
const SOCIAL_LINKS = [
  { icon: Github, link: PROFILE.github, label: "GitHub Profile" },
  { icon: Linkedin, link: PROFILE.linkedin, label: "LinkedIn Profile" },
  { icon: Mail, link: `mailto:${PROFILE.email}`, label: "Email Address" },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content={`${PROFILE.name} - ${PROFILE.jobTitle}`} />
              ...
              >
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex flex-row gap-3 w-full justify-start" data-aos="fade-up" data-aos-delay="1400">
                    <CTAButton href="#Portofolio" text="Highlights" icon={ExternalLink} />
