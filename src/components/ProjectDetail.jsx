  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      setProject({
        ...
        Github: selectedProject.Github || PROFILE.github,
      });
    }
  }, [slug]);
    ...
    return (
      <div className="min-h-screen bg-[#030014] flex items-center justify-center">
        <div className="text-center space-y-6 animate-fadeIn">
          ...
          <h2 className="text-xl md:text-3xl font-bold text-white">Loading details...</h2>
        </div>
      </div>
    );
  }

  const projectUrl = `${PROFILE.siteUrl}/project/${toSlug(project.Title)}`;
  const projectDescription = project.Description?.replace(/"/g, '\\"') || "";
        ...
        <meta
          ...
          content={
            project.Description
              ...
              : `Project ${project.Title} by ${PROFILE.name} - ${PROFILE.jobTitle}.`
          }
        />
